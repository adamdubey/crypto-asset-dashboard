            ...
            <div className="row mt-5 mt-xs-4">
                <div className="col-12 mb-3">
                    <div className="card-deck custom-card-deck">
                        <PriceCard header="Bitcoin(BTC)" src={'/bitcoin.png'} alt="fireSpot" label="(USD)" value={this.state.btcusd} />
                        <PriceCard header="Litecoin(LTC)" src={'/litecoin.png'} alt="fireSpot" label="(USD)" value={this.state.ltcusd} />
                        <PriceCard header="Ethereum(ETH)" src={'/ethereum.png'} alt="fireSpot" label="(USD)" value={this.state.ethusd} />
                        <PriceCard header="Ripple(XRP)" src={'/ripple.png'} alt="fireSpot" label="(USD)" value={this.state.xrpusd} />
                        <PriceCard header="EOS(EOS)" src={'eoscoin.jpg'} alt="fireSpot" label="(USD)" value={this.state.eosusd} />
